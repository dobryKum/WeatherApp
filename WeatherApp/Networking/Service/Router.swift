...
class Router<EndPoint: EndPointType>: NetworkRouter {
    ...
    fileprivate func configureParameters(bodyParameters: Parameters?,
        ...
        do {
            ...
            if let urlParameters = urlParameters {
                try URLParameterEnconding.encode(urlRequest: &request, with: urlParameters)
            }
        } catch {
            throw error
        }
    ...
    fileprivate func addAdditionalHeader(_ additionalHeaders: HTTPHeaders?, request: inout URLRequest) {
